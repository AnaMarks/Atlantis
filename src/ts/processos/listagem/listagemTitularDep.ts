...
export default class ListagemTitularDep extends Processo {
    private clientes: Cliente[]
    private impressor!: Impressor
    constructor() {super(), this.clientes = Armazem.InstanciaUnica.Clientes}

    processar(): void {
        console.clear()

        var processo = false
        let responsavel = this.entrada.receberTexto('Insira o número do documento do Titular responsável: ')
